...
import static fr.esgi.ville_jhipster.domain.JoueurAsserts.*;
import static fr.esgi.ville_jhipster.web.rest.TestUtil.createUpdateProxyForBean;
...
import fr.esgi.ville_jhipster.repository.JoueurRepository;
...
class JoueurResourceIT {
    ...
    void partialUpdateJoueurWithPatch() throws Exception {
        ...
        partialUpdatedJoueur.dateInscription(UPDATED_DATE_INSCRIPTION).estAdministrateur(UPDATED_EST_ADMINISTRATEUR);
