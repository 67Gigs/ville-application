...
import static fr.esgi.ville_jhipster.domain.VilleAsserts.*;
...
import fr.esgi.ville_jhipster.repository.VilleRepository;
...
class VilleResourceIT {
    ...
    void partialUpdateVilleWithPatch() throws Exception {
        ...
        partialUpdatedVille.nbHabitants(UPDATED_NB_HABITANTS);
